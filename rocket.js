...
var _chemmi$elm_rocket$Rocket_Types$StartscreenData = F2(
	function (a, b) {
...
var _chemmi$elm_rocket$Rocket_Types$AxisParallelRect = F3(
	function (a, b, c) {
		return {topLeft: a, height: b, width: c};
	});
...
var _chemmi$elm_rocket$Rocket_Types$NoMsg = {ctor: 'NoMsg'};
...
var _chemmi$elm_rocket$Rocket_Worlds$initWorld = {
	size: {ctor: '_Tuple2', _0: 800, _1: 600},
	axisParallelRects: _elm_lang$core$Native_List.fromArray(
		[
			{
			topLeft: {ctor: '_Tuple2', _0: -400, _1: -150},
			height: 150,
			width: 800
		}
		]),
	...
	_chemmi$elm_rocket$Rocket_Worlds$initWorld,
	{
		axisParallelRects: _elm_lang$core$Native_List.fromArray(
			[
				...
				{
				topLeft: {ctor: '_Tuple2', _0: 300, _1: 150},
				height: 150,
				width: 100
			}
			]),
		platforms: _elm_lang$core$Native_List.fromArray(
			[
				{
				center: {ctor: '_Tuple2', _0: 0, _1: -140},
				width: 50,
				marked: false
			}
			])
...
var _chemmi$elm_rocket$Rocket_Scene$rocketForm = function (rocket) {
	...
	return _evancz$elm_graphics$Collage$group(
		fire ? _elm_lang$core$Native_List.fromArray(
			[
...
var _chemmi$elm_rocket$Rocket_Scene$frameForm = F2(
	function (a, b) {
		...
		return A2(
			...
			_elm_lang$core$Native_Utils.update(
				line,
				{width: 2}),
			A2(_evancz$elm_graphics$Collage$rect, a, b));
	});
var _chemmi$elm_rocket$Rocket_Scene$background = F2(
	function (a, b) {
		return A2(
...
var _chemmi$elm_rocket$Rocket_Scene$worldForm = function (world) {
	var color = _elm_lang$core$Color$lightCharcoal;
	var polys = world.polygons;
	var rects = world.axisParallelRects;
	var _p3 = world.size;
	var a = _p3._0;
	var b = _p3._1;
	return _evancz$elm_graphics$Collage$group(
			...
			A2(
				...
				function (_p4) {
					return A2(
						_evancz$elm_graphics$Collage$filled,
						color,
						_chemmi$elm_rocket$Rocket_Scene$rectShape(_p4));
				},
				rects),
			A2(
				_elm_lang$core$List$map,
				function (_p5) {
					return A2(
						_evancz$elm_graphics$Collage$filled,
						color,
						_chemmi$elm_rocket$Rocket_Scene$polyShape(_p5));
				},
				polys)));
};
var _chemmi$elm_rocket$Rocket_Scene$drawScene = F2(
	function (world, rocket) {
		var _p6 = world.size;
		var a = _p6._0;
		var b = _p6._1;
		return A3(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_chemmi$elm_rocket$Rocket_Scene$background, a, b),
					...
					return A2(
						...
						A2(
							...
							_elm_lang$core$Basics$degrees(rocket.angle),
							_p7));
				}(
					_chemmi$elm_rocket$Rocket_Scene$rocketForm(rocket)),
					_chemmi$elm_rocket$Rocket_Scene$platformsForm(world.platforms),
					A2(_chemmi$elm_rocket$Rocket_Scene$frameForm, a, b)
				]));
	});

var _chemmi$elm_rocket$Rocket_Inits$initRocket = {
	acceleration: _chemmi$elm_rocket$Rocket_Worlds$initWorld.gravity * 3,
...
var _chemmi$elm_rocket$Rocket_Inits$initPlay = function () {
	var world = _chemmi$elm_rocket$Rocket_Worlds$world2;
	return {
...
var _chemmi$elm_rocket$Rocket_Inits$initStartscreen = {
	message: 'Startscreen - Press SPACE to start',
	background: A2(_chemmi$elm_rocket$Rocket_Scene$drawScene, _chemmi$elm_rocket$Rocket_Inits$initPlay.world, _chemmi$elm_rocket$Rocket_Inits$initPlay.rocket)
};
...
var _chemmi$elm_rocket$Rocket_Movement$tryLanding = F2(
	function (rocket, world) {
		var vyTolerance = 2;
		var vxTolerance = 1;
		var angleTolerance = 10;
		var roundedAngle = A2(
			_elm_lang$core$Basics_ops['%'],
			_elm_lang$core$Basics$round(rocket.angle),
			360);
		var _p5 = rocket.base;
		var b1 = _p5._0;
		var b2 = _p5._1;
		...
		var b2x = _p7._0;
		var b2y = _p7._1;
		var _p8 = rocket.position;
		var pos = _p8;
		var rx = _p8._0;
		var ry = _p8._1;
		var _p9 = rocket.velocity;
		var v = _p9;
		var vx = _p9._0;
		var vy = _p9._1;
		var landOnPlatform = function (platform) {
			var plathw = platform.width / 2;
			var _p10 = platform.center;
			var cx = _p10._0;
			var cy = _p10._1;
			return (((_elm_lang$core$Native_Utils.cmp(roundedAngle, angleTolerance) < 0) || (_elm_lang$core$Native_Utils.cmp(roundedAngle, 360 - angleTolerance) > 0)) && ((_elm_lang$core$Native_Utils.cmp(b1x + rx, cx - plathw) > 0) && ((_elm_lang$core$Native_Utils.cmp(b2x + rx, cx + plathw) < 0) && ((((_elm_lang$core$Native_Utils.cmp(b1y + ry, cy) < 1) && (_elm_lang$core$Native_Utils.cmp(b1y + ry, cy - 10) > 0)) || ((_elm_lang$core$Native_Utils.cmp(b2y + ry, cy) < 1) && (_elm_lang$core$Native_Utils.cmp(b2y + ry, cy - 10) > 0))) && ((_elm_lang$core$Native_Utils.cmp(
		...
		return _elm_lang$core$Maybe$oneOf(
			A2(_elm_lang$core$List$map, landOnPlatform, platforms));
	});
var _chemmi$elm_rocket$Rocket_Movement$startRocket = function (rocket) {
	var _p11 = rocket.position;
	var px = _p11._0;
	var py = _p11._1;
	return _elm_lang$core$Native_Utils.update(
		rocket,
...
var _chemmi$elm_rocket$Rocket_Movement$moveRocket = F4(
	function (keyDown, gravity, diffTime, rocket) {
		var diffSeconds = _elm_lang$core$Time$inSeconds(diffTime);
		var twist = rocket.twist;
		var acceleration = rocket.acceleration;
		var _p12 = rocket.velocity;
		var vx = _p12._0;
		var vy = _p12._1;
		var fire = rocket.fire;
		var angle = rocket.angle;
		var _p13 = rocket.position;
		var x = _p13._0;
		var y = _p13._1;
		return _elm_lang$core$Native_Utils.update(
			rocket,
			{
				angle: keyDown.left ? (angle + twist) : (keyDown.right ? (angle - twist) : angle),
				velocity: A3(
					_chemmi$elm_rocket$Rocket_Movement$accelerate,
					gravity * diffSeconds,
					180,
					(keyDown.forward ? A2(_chemmi$elm_rocket$Rocket_Movement$accelerate, acceleration * diffSeconds, angle) : _elm_lang$core$Basics$identity)(
...
var _chemmi$elm_rocket$Rocket_Collision$orientationTest = F3(
	function (_p2, _p1, _p0) {
		...
		var _p4 = _p1;
		var _p5 = _p0;
		var signedArea = ((_p4._0 - _p6) * (_p5._1 - _p7)) - ((_p5._0 - _p6) * (_p4._1 - _p7));
...
var _chemmi$elm_rocket$Rocket_Collision$collisionRocketRects = F2(
	function (rocket, rects) {
		var angle = rocket.angle;
		var cosAngle = _elm_lang$core$Basics$cos(
			_elm_lang$core$Basics$degrees(angle));
		var sinAngle = _elm_lang$core$Basics$sin(
			_elm_lang$core$Basics$degrees(angle));
		var rotate = function (_p12) {
			var _p13 = _p12;
			var _p15 = _p13._1;
			var _p14 = _p13._0;
			return {ctor: '_Tuple2', _0: (cosAngle * _p14) - (sinAngle * _p15), _1: (sinAngle * _p14) + (cosAngle * _p15)};
		};
		var _p16 = A2(
		...
		var _p17 = A2(
			...
			rocket.position,
			rotate(
				_elm_lang$core$Basics$fst(rocket.base)));
		var b1 = _p17;
		var b1x = _p17._0;
		var b1y = _p17._1;
		var _p18 = A2(
			...
			rocket.position,
			rotate(
				_elm_lang$core$Basics$snd(rocket.base)));
		var b2 = _p18;
		var b2x = _p18._0;
		var b2y = _p18._1;
		var ymax = A2(
...
var _chemmi$elm_rocket$Rocket_Collision$collision = F2(
	function (rocket, world) {
		return A2(_chemmi$elm_rocket$Rocket_Collision$collisionRocketRects, rocket, world.axisParallelRects);
	});
...
var _chemmi$elm_rocket$Rocket_Updates$markPlatform = F2(
	function (p, ps) {
		...
		if (_p0.ctor === '[]') {
			...
			var _p2 = _p0._1;
			var _p1 = _p0._0;
			return _elm_lang$core$Native_Utils.eq(p, _p1) ? A2(
				_elm_lang$core$List_ops['::'],
				_elm_lang$core$Native_Utils.update(
					p,
					{marked: true}),
				...
				_elm_lang$core$List_ops['::'],
				_p1,
				A2(_chemmi$elm_rocket$Rocket_Updates$markPlatform, p, _p2));
		}
	});
...
var _chemmi$elm_rocket$Rocket_Updates$updateLanded = function (data) {
	var rocket = data.rocket;
	var keyDown = data.keyDown;
	return keyDown.forward ? _elm_lang$core$Native_Utils.update(
		data,
		{
			rocket: _chemmi$elm_rocket$Rocket_Movement$startRocket(rocket)
		}) : data;
};
var _chemmi$elm_rocket$Rocket_Updates$updateLanding = function (data) {
	var rocket = data.rocket;
	var world = data.world;
	var platforms = world.platforms;
	var _p6 = rocket.movement;
	if (_p6.ctor === 'Landing') {
		var _p7 = _p6._0;
		return _elm_lang$core$Native_Utils.update(
			data,
			{
				rocket: A2(_chemmi$elm_rocket$Rocket_Movement$landOn, _p7, rocket),
				world: _elm_lang$core$Native_Utils.update(
					world,
					{
						platforms: A2(_chemmi$elm_rocket$Rocket_Updates$markPlatform, _p7, platforms)
					})
			});
	} else {
		return data;
...
var _chemmi$elm_rocket$Rocket_Updates$updateFlying = F2(
	function (data, diffTime) {
		var keyDown = data.keyDown;
		var rocket = data.rocket;
		var world = data.world;
		var movedRocket = A4(_chemmi$elm_rocket$Rocket_Movement$moveRocket, keyDown, world.gravity, diffTime, rocket);
		var _p8 = A2(_chemmi$elm_rocket$Rocket_Movement$tryLanding, movedRocket, world);
		if (_p8.ctor === 'Just') {
			return _elm_lang$core$Native_Utils.update(
				data,
				{
					rocket: _elm_lang$core$Native_Utils.update(
						movedRocket,
						{
							movement: _chemmi$elm_rocket$Rocket_Types$Landing(_p8._0)
						})
				});
		} else {
			return A2(_chemmi$elm_rocket$Rocket_Collision$collision, movedRocket, world) ? _elm_lang$core$Native_Utils.update(
				data,
				{
					rocket: _elm_lang$core$Native_Utils.update(
						movedRocket,
				...
				return _elm_lang$core$Native_Utils.update(
					data,
					{
						keyDown: A2(
							...
							keyDown,
							_chemmi$elm_rocket$Rocket_Types$KeyDownMsg(_p9._0))
					});
			case 'KeyUpMsg':
				return _elm_lang$core$Native_Utils.update(
					data,
					{
						keyDown: A2(
							_chemmi$elm_rocket$Rocket_Updates$updateKeyDown,
							keyDown,
							_chemmi$elm_rocket$Rocket_Types$KeyUpMsg(_p9._0))
					});
			case 'Step':
				var _p10 = rocket.movement;
				switch (_p10.ctor) {
					case 'Landed':
						return _chemmi$elm_rocket$Rocket_Updates$updateLanded(data);
					case 'Landing':
						return _chemmi$elm_rocket$Rocket_Updates$updateLanding(data);
					case 'Colliding':
						return _chemmi$elm_rocket$Rocket_Updates$updateColliding(data);
					default:
						return A2(_chemmi$elm_rocket$Rocket_Updates$updateFlying, data, _p9._0);
				}
			default:
				return data;
		}
...
var _chemmi$elm_rocket$Rocket_Views$viewPlayStatus = function (data) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Play Status')
					])),
				A2(
				_elm_lang$html$Html$table,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_chemmi$elm_rocket$Rocket_Views$viewValue, 'Gameover', data.gameover)
					]))
			]));
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(_chemmi$elm_rocket$Rocket_Scene$drawScene, world, rocket)),
				_chemmi$elm_rocket$Rocket_Views$viewRocketStatus(rocket),
				_chemmi$elm_rocket$Rocket_Views$viewPlayStatus(data)
			]));
};
...
var _chemmi$elm_rocket$Rocket$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _chemmi$elm_rocket$Rocket_Inits$init, _1: _elm_lang$core$Platform_Cmd$none},
			view: _chemmi$elm_rocket$Rocket$view,
			update: F2(
				function (msg, playModel) {
					return {
						ctor: '_Tuple2',
						_0: A2(_chemmi$elm_rocket$Rocket$update, msg, playModel),
