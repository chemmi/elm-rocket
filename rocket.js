...
var _chemmi$elm_rocket$Rocket_Types$InfoData = F3(
	function (a, b, c) {
		return {accelerateAnimation: a, rotateAnimation: b, landAnimation: c};
	});
var _chemmi$elm_rocket$Rocket_Types$PortraitData = F2(
	function (a, b) {
		return {rocket: a, platform: b};
	});
...
var _chemmi$elm_rocket$Rocket_Types$KeyDown = F3(
	function (a, b, c) {
		return {left: a, right: b, up: c};
	});
var _chemmi$elm_rocket$Rocket_Types$Rocket = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {position: a, movement: b, onPlatform: c, fire: d, angle: e, velocity: f, acceleration: g, twist: h, touchesWorld: i, base: j, top: k};
										};
									};
								};
							};
...
var _chemmi$elm_rocket$Rocket_Types$World = F8(
	function (a, b, c, d, e, f, g, h) {
		return {size: a, rects: b, polygons: c, platforms: d, rocketStartPosition: e, gravity: f, totalTime: g, isWin: h};
	});
var _chemmi$elm_rocket$Rocket_Types$Platform = F3(
	function (a, b, c) {
		return {center: a, width: b, marked: c};
	});
var _chemmi$elm_rocket$Rocket_Types$Rect = F3(
	function (a, b, c) {
		return {topLeft: a, width: b, height: c};
	});
var _chemmi$elm_rocket$Rocket_Types$Model = F2(
	function (a, b) {
		return {ctor: 'Model', _0: a, _1: b};
	});
var _chemmi$elm_rocket$Rocket_Types$WinScreen = function (a) {
	return {ctor: 'WinScreen', _0: a};
};
var _chemmi$elm_rocket$Rocket_Types$GameoverScreen = function (a) {
	return {ctor: 'GameoverScreen', _0: a};
};
var _chemmi$elm_rocket$Rocket_Types$WorldChoiceScreen = function (a) {
	return {ctor: 'WorldChoiceScreen', _0: a};
};
var _chemmi$elm_rocket$Rocket_Types$PlayScreen = function (a) {
	return {ctor: 'PlayScreen', _0: a};
};
var _chemmi$elm_rocket$Rocket_Types$InfoScreen = function (a) {
	return {ctor: 'InfoScreen', _0: a};
};
var _chemmi$elm_rocket$Rocket_Types$StartScreen = {ctor: 'StartScreen'};
var _chemmi$elm_rocket$Rocket_Types$TimerTick = {ctor: 'TimerTick'};
var _chemmi$elm_rocket$Rocket_Types$Step = function (a) {
	return {ctor: 'Step', _0: a};
};
var _chemmi$elm_rocket$Rocket_Types$KeyUpMsg = function (a) {
	return {ctor: 'KeyUpMsg', _0: a};
};
var _chemmi$elm_rocket$Rocket_Types$KeyDownMsg = function (a) {
...
var _chemmi$elm_rocket$Rocket_Types$Up = {ctor: 'Up'};
var _chemmi$elm_rocket$Rocket_Types$Right = {ctor: 'Right'};
var _chemmi$elm_rocket$Rocket_Types$Left = {ctor: 'Left'};
var _chemmi$elm_rocket$Rocket_Types$Win = function (a) {
	return {ctor: 'Win', _0: a};
};
var _chemmi$elm_rocket$Rocket_Types$Gameover = function (a) {
	return {ctor: 'Gameover', _0: a};
};
var _chemmi$elm_rocket$Rocket_Types$Colliding = {ctor: 'Colliding'};
var _chemmi$elm_rocket$Rocket_Types$Flying = {ctor: 'Flying'};
var _chemmi$elm_rocket$Rocket_Types$Landing = function (a) {
	return {ctor: 'Landing', _0: a};
};
var _chemmi$elm_rocket$Rocket_Types$Landed = function (a) {
	return {ctor: 'Landed', _0: a};
};

var _chemmi$elm_rocket$Rocket_Worlds$initWorld = function () {
	var size = {ctor: '_Tuple2', _0: 800, _1: 600};
	return {
		size: size,
		gravity: 3,
		totalTime: 60 * _elm_lang$core$Time$second,
		isWin: _elm_lang$core$List$all(
			function (_) {
				return _.marked;
			}),
		rects: _elm_lang$core$Native_List.fromArray(
			[
				A3(
				_chemmi$elm_rocket$Rocket_Types$Rect,
				{
					ctor: '_Tuple2',
					_0: 0 - (_elm_lang$core$Basics$fst(size) / 2),
					_1: 0 - (_elm_lang$core$Basics$snd(size) / 3)
				},
				_elm_lang$core$Basics$fst(size),
				_elm_lang$core$Basics$snd(size) / 6)
			]),
		polygons: _elm_lang$core$Native_List.fromArray(
			[]),
		platforms: _elm_lang$core$Native_List.fromArray(
			[
				{
				center: {ctor: '_Tuple2', _0: 0, _1: -200},
				width: 70,
				marked: false
			}
			]),
		rocketStartPosition: {ctor: '_Tuple2', _0: 0, _1: 150}
	};
}();
var _chemmi$elm_rocket$Rocket_Worlds$twoPlatforms = _elm_lang$core$Native_Utils.update(
	_chemmi$elm_rocket$Rocket_Worlds$initWorld,
	{
		...
		rocketStartPosition: {ctor: '_Tuple2', _0: -200, _1: 150}
	});
var _chemmi$elm_rocket$Rocket_Worlds$outOfSight = _elm_lang$core$Native_Utils.update(
	_chemmi$elm_rocket$Rocket_Worlds$initWorld,
	{
		size: {ctor: '_Tuple2', _0: 1600, _1: 600},
		rects: _elm_lang$core$Native_List.fromArray(
			[
				A3(
				_chemmi$elm_rocket$Rocket_Types$Rect,
				{ctor: '_Tuple2', _0: -800, _1: -250},
				1600,
				50)
			]),
		polygons: _elm_lang$core$Native_List.fromArray(
		...
		rocketStartPosition: {ctor: '_Tuple2', _0: -600, _1: 150}
	});
var _chemmi$elm_rocket$Rocket_Worlds$visitChambers = _elm_lang$core$Native_Utils.update(
	_chemmi$elm_rocket$Rocket_Worlds$initWorld,
	{
		size: {ctor: '_Tuple2', _0: 1600, _1: 1200},
		rects: _elm_lang$core$Native_List.fromArray(
			[
				A3(
				_chemmi$elm_rocket$Rocket_Types$Rect,
				...
				A3(
				_chemmi$elm_rocket$Rocket_Types$Rect,
				{ctor: '_Tuple2', _0: 750, _1: 600},
				50,
				1200),
				A3(
				_chemmi$elm_rocket$Rocket_Types$Rect,
				{ctor: '_Tuple2', _0: -750, _1: -550},
				1500,
				50),
				A3(
				_chemmi$elm_rocket$Rocket_Types$Rect,
				...
				A3(
				_chemmi$elm_rocket$Rocket_Types$Rect,
				{ctor: '_Tuple2', _0: -750, _1: 200},
				400,
				50),
				A3(
				_chemmi$elm_rocket$Rocket_Types$Rect,
				{ctor: '_Tuple2', _0: 350, _1: 200},
				400,
				50)
			]),
		polygons: _elm_lang$core$Native_List.fromArray(
		...
		platforms: _elm_lang$core$Native_List.fromArray(
			[
				A3(
				_chemmi$elm_rocket$Rocket_Types$Platform,
				{ctor: '_Tuple2', _0: 0, _1: -550},
				70,
				false),
				A3(
				_chemmi$elm_rocket$Rocket_Types$Platform,
				{ctor: '_Tuple2', _0: -550, _1: 200},
				70,
				false),
				A3(
				_chemmi$elm_rocket$Rocket_Types$Platform,
		...
		rocketStartPosition: {ctor: '_Tuple2', _0: 0, _1: -540}
	});
var _chemmi$elm_rocket$Rocket_Worlds$allWorlds = _elm_lang$core$Native_List.fromArray(
	[_chemmi$elm_rocket$Rocket_Worlds$initWorld, _chemmi$elm_rocket$Rocket_Worlds$twoPlatforms, _chemmi$elm_rocket$Rocket_Worlds$outOfSight, _chemmi$elm_rocket$Rocket_Worlds$visitChambers]);
...
var _chemmi$elm_rocket$Rocket_Scene$countdownForm = function (t) {
	var $default = _evancz$elm_graphics$Text$defaultStyle;
	var style = _elm_lang$core$Native_Utils.update(
		$default,
		{
...
var _chemmi$elm_rocket$Rocket_Scene$rocketForm = function (_p0) {
	...
	var base1 = _p2._0;
	var base2 = _p2._1;
	var bodyShape = _evancz$elm_graphics$Collage$polygon(
		_elm_lang$core$Native_List.fromArray(
			[
				base1,
				_p4,
	...
	return function (_p3) {
		return A2(
			...
			A2(
				...
				_elm_lang$core$Basics$degrees(_p1.angle),
				_p3));
	}(
...
var _chemmi$elm_rocket$Rocket_Scene$platformShape = function (platform) {
	...
	return _evancz$elm_graphics$Collage$polygon(
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: x - hWidth, _1: y},
				{ctor: '_Tuple2', _0: x + hWidth, _1: y},
				{ctor: '_Tuple2', _0: x + hWidth, _1: y - height},
				{ctor: '_Tuple2', _0: x - hWidth, _1: y - height}
			]));
};
var _chemmi$elm_rocket$Rocket_Scene$platformsForm = function (platforms) {
	...
	var pForm = function (p) {
		var pS = _chemmi$elm_rocket$Rocket_Scene$platformShape(p);
...
var _chemmi$elm_rocket$Rocket_Scene$drawWorldThumbnail = function (world) {
	var initRocket = {
		...
		movement: _chemmi$elm_rocket$Rocket_Types$Flying,
		onPlatform: _elm_lang$core$Maybe$Nothing,
		fire: false,
		angle: 0,
	...
	var rocket = _elm_lang$core$Native_Utils.update(
		initRocket,
		{position: world.rocketStartPosition});
	var displaySize = {ctor: '_Tuple2', _0: 800, _1: 600};
	var factorx = _elm_lang$core$Basics$toFloat(
		_elm_lang$core$Basics$fst(displaySize)) / _elm_lang$core$Basics$fst(world.size);
	var factory = _elm_lang$core$Basics$toFloat(
		_elm_lang$core$Basics$snd(displaySize)) / _elm_lang$core$Basics$snd(world.size);
	var factor = A2(_elm_lang$core$Basics$min, factorx, factory);
	return A3(
		_elm_lang$core$Basics$uncurry,
		_evancz$elm_graphics$Collage$collage,
		displaySize,
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_evancz$elm_graphics$Collage$group(
					_elm_lang$core$Native_List.fromArray(
						[
							_chemmi$elm_rocket$Rocket_Scene$backgroundForm(world.size),
							_chemmi$elm_rocket$Rocket_Scene$worldForm(world),
							_chemmi$elm_rocket$Rocket_Scene$rocketForm(rocket),
							_chemmi$elm_rocket$Rocket_Scene$frameForm(world.size)
						])))
			]));
};

var _chemmi$elm_rocket$Rocket_Inits$initRocket = {
	acceleration: _chemmi$elm_rocket$Rocket_Worlds$initWorld.gravity * 2,
	position: {ctor: '_Tuple2', _0: 0, _1: 0},
	movement: _chemmi$elm_rocket$Rocket_Types$Flying,
	onPlatform: _elm_lang$core$Maybe$Nothing,
	fire: false,
...
var _chemmi$elm_rocket$Rocket_Inits$initPlay = function () {
	var world = _chemmi$elm_rocket$Rocket_Worlds$visitChambers;
	return {
		keyDown: _chemmi$elm_rocket$Rocket_Inits$noKeyDown,
		timeRemaining: world.totalTime,
		displaySize: {ctor: '_Tuple2', _0: 800, _1: 600},
		displayPosition: {ctor: '_Tuple2', _0: 0, _1: 0},
		world: world,
...
var _chemmi$elm_rocket$Rocket_Collision$polyToSegments = function (poly) {
	var help = function (poly) {
		var _p0 = poly;
		if (_p0.ctor === '[]') {
			return _elm_lang$core$Native_List.fromArray(
				[]);
	...
	var _p2 = _elm_community$list_extra$List_Extra$last(poly);
	if (_p2.ctor === 'Just') {
		var _p3 = _elm_lang$core$List$head(poly);
		if (_p3.ctor === 'Just') {
			return A2(
				_elm_lang$core$List_ops['::'],
			...
			return _elm_lang$core$Native_Utils.crashCase(
				'Rocket.Collision',
				{
					start: {line: 357, column: 17},
					end: {line: 362, column: 64}
				},
				_p3)('Empty Polygon detected :(');
		}
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
			'Rocket.Collision',
			{
				start: {line: 355, column: 9},
				end: {line: 365, column: 56}
			},
			_p2)('Empty Polygon detected :(');
	}
};
var _chemmi$elm_rocket$Rocket_Collision$orientationTest = F3(
	function (_p8, _p7, _p6) {
		...
		var _p10 = _p7;
		var _p11 = _p6;
		var signedArea = ((_p10._0 - _p12) * (_p11._1 - _p13)) - ((_p11._0 - _p12) * (_p10._1 - _p13));
		return _elm_lang$core$Native_Utils.cmp(signedArea, 0) > 0;
	});
var _chemmi$elm_rocket$Rocket_Collision$addPoints = F2(
	function (_p15, _p14) {
		var _p16 = _p15;
		var _p17 = _p14;
		return {ctor: '_Tuple2', _0: _p16._0 + _p17._0, _1: _p16._1 + _p17._1};
	});
var _chemmi$elm_rocket$Rocket_Collision$collisionRocketPlatforms = F2(
	function (_p18, platforms) {
		var _p19 = _p18;
		var _p32 = _p19.position;
		var _p31 = _p19.base;
		var _p30 = _p19.angle;
		var sinAngle = _elm_lang$core$Basics$sin(
			_elm_lang$core$Basics$degrees(_p30));
		var cosAngle = _elm_lang$core$Basics$cos(
			_elm_lang$core$Basics$degrees(_p30));
		var rotate = function (_p20) {
			var _p21 = _p20;
			var _p23 = _p21._1;
			var _p22 = _p21._0;
			return {ctor: '_Tuple2', _0: (cosAngle * _p22) - (sinAngle * _p23), _1: (sinAngle * _p22) + (cosAngle * _p23)};
		};
		var _p24 = A2(
			_chemmi$elm_rocket$Rocket_Collision$addPoints,
			_p32,
			rotate(_p19.top));
		var t = _p24;
		var tx = _p24._0;
		...
		var _p25 = A2(
			...
			_p32,
			rotate(
				_elm_lang$core$Basics$fst(_p31)));
		var b1 = _p25;
		var b1x = _p25._0;
		var b1y = _p25._1;
		var _p26 = A2(
			...
			_p32,
			rotate(
				_elm_lang$core$Basics$snd(_p31)));
		var b2 = _p26;
		var b2x = _p26._0;
		var b2y = _p26._1;
		var ymax = A2(
			_elm_lang$core$Basics$max,
			ty,
			A2(_elm_lang$core$Basics$max, b1y, b2y));
		var ymin = A2(
			_elm_lang$core$Basics$min,
			ty,
			A2(_elm_lang$core$Basics$min, b1y, b2y));
		var xmax = A2(
			_elm_lang$core$Basics$max,
			tx,
			A2(_elm_lang$core$Basics$max, b1x, b2x));
		var xmin = A2(
			_elm_lang$core$Basics$min,
			tx,
			A2(_elm_lang$core$Basics$min, b1x, b2x));
		var collPlatformCoarse = function (platform) {
			var hw = platform.width / 2;
			var h = 10;
			var _p27 = platform.center;
			var cx = _p27._0;
			var cy = _p27._1;
			return _elm_lang$core$Basics$not(
				(_elm_lang$core$Native_Utils.cmp(cx - hw, xmax) > 0) || ((_elm_lang$core$Native_Utils.cmp(cy, ymin) < 0) || ((_elm_lang$core$Native_Utils.cmp(cx + hw, xmin) < 0) || (_elm_lang$core$Native_Utils.cmp(cy - h, ymax) > 0)))) ? _elm_lang$core$Maybe$Just(platform) : _elm_lang$core$Maybe$Nothing;
		};
		var collPlatformFine = function (platform) {
			var ot = _chemmi$elm_rocket$Rocket_Collision$orientationTest;
			var hw = platform.width / 2;
			var h = 10;
			var _p28 = platform.center;
			var cx = _p28._0;
			var cy = _p28._1;
			var edges = _elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: cx - hw, _1: cy},
					{ctor: '_Tuple2', _0: cx + hw, _1: cy},
					{ctor: '_Tuple2', _0: cx + hw, _1: cy - h},
					{ctor: '_Tuple2', _0: cx - hw, _1: cy - h}
				]);
			var _p29 = collPlatformCoarse(platform);
			if (_p29.ctor === 'Just') {
				return _elm_lang$core$Basics$not(
					A2(
						_elm_lang$core$List$all,
						...
						_elm_lang$core$List$all,
						A2(ot, b2, b1),
						edges))) ? _elm_lang$core$Maybe$Just(platform) : _elm_lang$core$Maybe$Nothing;
			} else {
				return _elm_lang$core$Maybe$Nothing;
			}
		};
		var collPlatform = function (platform) {
			return collPlatformFine(platform);
		};
		return _elm_lang$core$Maybe$oneOf(
			A2(_elm_lang$core$List$map, collPlatform, platforms));
	});
var _chemmi$elm_rocket$Rocket_Collision$collisionRocketPolygons = F2(
	function (_p33, polygons) {
		var _p34 = _p33;
		var _p41 = _p34.position;
		var _p40 = _p34.base;
		var _p39 = _p34.angle;
		var ot = _chemmi$elm_rocket$Rocket_Collision$orientationTest;
		var sinAngle = _elm_lang$core$Basics$sin(
			_elm_lang$core$Basics$degrees(_p39));
		var cosAngle = _elm_lang$core$Basics$cos(
			_elm_lang$core$Basics$degrees(_p39));
		var rotate = function (_p35) {
			var _p36 = _p35;
			var _p38 = _p36._1;
			var _p37 = _p36._0;
			return {ctor: '_Tuple2', _0: (cosAngle * _p37) - (sinAngle * _p38), _1: (sinAngle * _p37) + (cosAngle * _p38)};
		};
		var t = A2(
			_chemmi$elm_rocket$Rocket_Collision$addPoints,
			_p41,
		...
		var b2 = A2(
			...
			_p41,
			rotate(
				_elm_lang$core$Basics$snd(_p40)));
		var collPolyCoarse = function (poly) {
			return _elm_lang$core$Basics$not(
				A2(
					_elm_lang$core$List$all,
					A2(ot, t, b2),
		...
		var otLineRocket = function (l) {
			return A2(
				_elm_lang$core$List$all,
				A2(_elm_lang$core$Basics$uncurry, ot, l),
				_elm_lang$core$Native_List.fromArray(
					[t, b1, b2]));
		};
		var collPolyFine = function (poly) {
			var segments = _chemmi$elm_rocket$Rocket_Collision$polyToSegments(poly);
			return collPolyCoarse(poly) && _elm_lang$core$Basics$not(
				A2(_elm_lang$core$List$any, otLineRocket, segments));
		};
		return A2(_elm_lang$core$List$any, collPolyFine, polygons);
	});
var _chemmi$elm_rocket$Rocket_Collision$collisionRocketBorder = F2(
	function (_p43, _p42) {
		var _p44 = _p43;
		var _p59 = _p44.position;
		var _p58 = _p44.base;
		var _p57 = _p44.angle;
		var _p45 = _p42;
		var _p56 = _p45._0;
		var _p55 = _p45._1;
		var inBorder = function (_p46) {
			var _p47 = _p46;
			var _p49 = _p47._1;
			var _p48 = _p47._0;
			return (_elm_lang$core$Native_Utils.cmp((0 - _p56) / 2, _p48) < 0) && ((_elm_lang$core$Native_Utils.cmp(_p48, _p56 / 2) < 0) && ((_elm_lang$core$Native_Utils.cmp((0 - _p55) / 2, _p49) < 0) && (_elm_lang$core$Native_Utils.cmp(_p49, _p55 / 2) < 0)));
		};
		var sinAngle = _elm_lang$core$Basics$sin(
			_elm_lang$core$Basics$degrees(_p57));
		var cosAngle = _elm_lang$core$Basics$cos(
			_elm_lang$core$Basics$degrees(_p57));
		var rotate = function (_p50) {
			var _p51 = _p50;
			var _p53 = _p51._1;
			var _p52 = _p51._0;
			return {ctor: '_Tuple2', _0: (cosAngle * _p52) - (sinAngle * _p53), _1: (sinAngle * _p52) + (cosAngle * _p53)};
		};
		var t = A2(
			_chemmi$elm_rocket$Rocket_Collision$addPoints,
			_p59,
...
var _chemmi$elm_rocket$Rocket_Collision$collisionRocketRects = F2(
	function (_p60, rects) {
		var _p61 = _p60;
		var _p73 = _p61.position;
		var _p72 = _p61.base;
		var _p71 = _p61.angle;
		var sinAngle = _elm_lang$core$Basics$sin(
			_elm_lang$core$Basics$degrees(_p71));
		var cosAngle = _elm_lang$core$Basics$cos(
			_elm_lang$core$Basics$degrees(_p71));
		var rotate = function (_p62) {
			var _p63 = _p62;
			var _p65 = _p63._1;
			var _p64 = _p63._0;
			return {ctor: '_Tuple2', _0: (cosAngle * _p64) - (sinAngle * _p65), _1: (sinAngle * _p64) + (cosAngle * _p65)};
		};
		var _p66 = A2(
			_chemmi$elm_rocket$Rocket_Collision$addPoints,
			_p73,
		...
		var collRectCoarse = function (r) {
			...
			var ry = _p69._1;
			return _elm_lang$core$Basics$not(
				(_elm_lang$core$Native_Utils.cmp(rx, xmax) > 0) || ((_elm_lang$core$Native_Utils.cmp(ry, ymin) < 0) || ((_elm_lang$core$Native_Utils.cmp(rx + w, xmin) < 0) || (_elm_lang$core$Native_Utils.cmp(ry - h, ymax) > 0))));
		};
		var collRectFine = function (r) {
			var ot = _chemmi$elm_rocket$Rocket_Collision$orientationTest;
			var w = r.width;
			var h = r.height;
			var _p70 = r.topLeft;
			...
			var edges = _elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: rx, _1: ry},
					{ctor: '_Tuple2', _0: rx + w, _1: ry},
					{ctor: '_Tuple2', _0: rx + w, _1: ry - h},
					{ctor: '_Tuple2', _0: rx, _1: ry - h}
				]);
			return collRectCoarse(r) && _elm_lang$core$Basics$not(
				A2(
					_elm_lang$core$List$all,
					A2(ot, t, b2),
					edges) || (A2(
		...
		var collRect = function (r) {
			return collRectFine(r);
		};
		return A2(_elm_lang$core$List$any, collRect, rects);
	});
var _chemmi$elm_rocket$Rocket_Collision$collision = F2(
	function (rocket, _p74) {
		var _p75 = _p74;
		return A2(_chemmi$elm_rocket$Rocket_Collision$collisionRocketRects, rocket, _p75.rects) || (A2(_chemmi$elm_rocket$Rocket_Collision$collisionRocketBorder, rocket, _p75.size) || A2(_chemmi$elm_rocket$Rocket_Collision$collisionRocketPolygons, rocket, _p75.polygons));
	});

var _chemmi$elm_rocket$Rocket_Movement$accelerate = F3(
	function (acceleration, angle, _p0) {
		var _p1 = _p0;
		var deg = _elm_lang$core$Basics$degrees(angle + 90);
		return {
			ctor: '_Tuple2',
			_0: (acceleration * _elm_lang$core$Basics$cos(deg)) + _p1._0,
			_1: (acceleration * _elm_lang$core$Basics$sin(deg)) + _p1._1
		};
	});
var _chemmi$elm_rocket$Rocket_Movement$landOn = F2(
	function (platform, rocket) {
		var _p2 = platform.center;
		var cx = _p2._0;
		var cy = _p2._1;
		var _p3 = _elm_lang$core$Basics$fst(rocket.base);
		var b1x = _p3._0;
		var b1y = _p3._1;
		var _p4 = rocket.position;
		var rx = _p4._0;
		var ry = _p4._1;
		return _elm_lang$core$Native_Utils.update(
			rocket,
			{
				movement: _chemmi$elm_rocket$Rocket_Types$Landed(platform),
				position: {ctor: '_Tuple2', _0: rx, _1: cy - b1y},
				velocity: {ctor: '_Tuple2', _0: 0, _1: 0},
				angle: 0,
				fire: false
			});
	});
var _chemmi$elm_rocket$Rocket_Movement$tryLanding = F2(
	function (_p6, _p5) {
		var _p7 = _p6;
		var _p14 = _p7.base;
		var _p8 = _p5;
		var vyTolerance = 5;
		var vxTolerance = 3;
		var angleTolerance = 15;
		var roundedAngle = A2(
			_elm_lang$core$Basics_ops['%'],
			_elm_lang$core$Basics$round(_p7.angle),
			360);
		var _p9 = _elm_lang$core$Basics$snd(_p14);
		var b2x = _p9._0;
		var b2y = _p9._1;
		var _p10 = _elm_lang$core$Basics$fst(_p14);
		var b1x = _p10._0;
		var b1y = _p10._1;
		var _p11 = _p7.position;
		var rx = _p11._0;
		var ry = _p11._1;
		var _p12 = _p7.velocity;
		var vx = _p12._0;
		var vy = _p12._1;
		var landOnPlatform = function (platform) {
			var plathw = platform.width / 2;
			var _p13 = platform.center;
			var cx = _p13._0;
			var cy = _p13._1;
			return (((_elm_lang$core$Native_Utils.cmp(roundedAngle, angleTolerance) < 0) || (_elm_lang$core$Native_Utils.cmp(roundedAngle, 360 - angleTolerance) > 0)) && ((_elm_lang$core$Native_Utils.cmp(b1x + rx, cx - plathw) > 0) && ((_elm_lang$core$Native_Utils.cmp(b2x + rx, cx + plathw) < 0) && ((_elm_lang$core$Native_Utils.cmp(
				_elm_lang$core$Basics$abs(vx),
				vxTolerance) < 0) && (_elm_lang$core$Native_Utils.cmp(
				_elm_lang$core$Basics$abs(vy),
				vyTolerance) < 0))))) ? _elm_lang$core$Maybe$Just(platform) : _elm_lang$core$Maybe$Nothing;
		};
		return A2(
			_elm_lang$core$Maybe$andThen,
			A2(_chemmi$elm_rocket$Rocket_Collision$collisionRocketPlatforms, _p7, _p8.platforms),
			landOnPlatform);
	});
var _chemmi$elm_rocket$Rocket_Movement$startRocket = function (rocket) {
	var _p15 = rocket.position;
	var px = _p15._0;
	var py = _p15._1;
	return _elm_lang$core$Native_Utils.update(
		rocket,
		{
			movement: _chemmi$elm_rocket$Rocket_Types$Flying,
			position: {ctor: '_Tuple2', _0: px, _1: py + 1},
			fire: true,
			onPlatform: _elm_lang$core$Maybe$Nothing
		});
};
var _chemmi$elm_rocket$Rocket_Movement$moveRocket = F4(
	function (keyDown, gravity, diffTime, _p16) {
		var _p17 = _p16;
		var _p21 = _p17.twist;
		var _p20 = _p17.angle;
		var diffSeconds = _elm_lang$core$Time$inSeconds(diffTime);
		var _p18 = _p17.velocity;
		var vx = _p18._0;
		var vy = _p18._1;
		var _p19 = _p17.position;
		var x = _p19._0;
		var y = _p19._1;
		return _elm_lang$core$Native_Utils.update(
			_p17,
			{
				angle: keyDown.left ? (_p20 + _p21) : (keyDown.right ? (_p20 - _p21) : _p20),
				velocity: A3(
					_chemmi$elm_rocket$Rocket_Movement$accelerate,
					gravity * diffSeconds,
					180,
					(keyDown.up ? A2(_chemmi$elm_rocket$Rocket_Movement$accelerate, _p17.acceleration * diffSeconds, _p20) : _elm_lang$core$Basics$identity)(
						{ctor: '_Tuple2', _0: vx, _1: vy})),
				position: {ctor: '_Tuple2', _0: vx + x, _1: vy + y},
				fire: keyDown.up
			});
	});
...
var _chemmi$elm_rocket$Rocket_Updates$rotateLeft = function (xs) {
	...
	if (_p0.ctor === '[]') {
		...
		var _p5 = _p0;
		var xs$ = function () {
			var _p1 = _elm_community$list_extra$List_Extra$init(_p5);
			if (_p1.ctor === 'Just') {
				return _p1._0;
			} else {
				return _elm_lang$core$Native_Utils.crashCase(
		...
		var x$ = function () {
			var _p3 = _elm_community$list_extra$List_Extra$last(_p5);
			if (_p3.ctor === 'Just') {
				return _p3._0;
			} else {
				return _elm_lang$core$Native_Utils.crashCase(
...
var _chemmi$elm_rocket$Rocket_Updates$markPlatform = F2(
	function (p, ps) {
		return A3(
			_elm_community$list_extra$List_Extra$updateIf,
			F2(
...
var _chemmi$elm_rocket$Rocket_Updates$updateKeyDown = F2(
...
var _chemmi$elm_rocket$Rocket_Updates$updateDisplayPosition = function (_p11) {
	var _p12 = _p11;
	var _p13 = _p12.rocket.position;
	var rx = _p13._0;
	var ry = _p13._1;
	var _p14 = {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Basics$round(rx),
		_1: _elm_lang$core$Basics$round(ry)
	};
	var rrx = _p14._0;
	var rry = _p14._1;
	var _p15 = _p12.world.size;
	var wW = _p15._0;
	var wH = _p15._1;
	var _p16 = _p12.displaySize;
	var dW = _p16._0;
	var dH = _p16._1;
	var tolerancex = (dW / 4) | 0;
	var tolerancey = (dH / 4) | 0;
	var fokusRocket = function (_p17) {
		var _p18 = _p17;
		var _p20 = _p18._1;
		var _p19 = _p18._0;
		var dy$ = (_p20 + A2(_elm_lang$core$Basics$max, 0, (rry - _p20) - tolerancey)) + A2(_elm_lang$core$Basics$min, 0, (rry - _p20) + tolerancey);
		var dx$ = (_p19 + A2(_elm_lang$core$Basics$max, 0, (rrx - _p19) - tolerancex)) + A2(_elm_lang$core$Basics$min, 0, (rrx - _p19) + tolerancex);
		return {ctor: '_Tuple2', _0: dx$, _1: dy$};
	};
	var stayInFrame = function (_p21) {
		var _p22 = _p21;
		var dy$ = A2(
			_elm_lang$core$Basics$max,
			_elm_lang$core$Basics$round((0 - wH) / 2) + ((dH / 2) | 0),
			_p22._1);
		var dy$$ = A2(
			_elm_lang$core$Basics$min,
			_elm_lang$core$Basics$round(wH / 2) - ((dH / 2) | 0),
			dy$);
		var dx$ = A2(
			_elm_lang$core$Basics$max,
			_elm_lang$core$Basics$round((0 - wW) / 2) + ((dW / 2) | 0),
			_p22._0);
		var dx$$ = A2(
			_elm_lang$core$Basics$min,
			_elm_lang$core$Basics$round(wW / 2) - ((dW / 2) | 0),
			dx$);
		return {ctor: '_Tuple2', _0: dx$$, _1: dy$$};
	};
	return _elm_lang$core$Native_Utils.update(
		_p12,
		{
			displayPosition: stayInFrame(
				fokusRocket(_p12.displayPosition))
		});
};
var _chemmi$elm_rocket$Rocket_Updates$updateLanded = function (_p23) {
	var _p24 = _p23;
	var _p25 = _p24;
	return _p24.keyDown.up ? _elm_lang$core$Native_Utils.update(
		_p25,
		{
			rocket: _chemmi$elm_rocket$Rocket_Movement$startRocket(_p24.rocket)
		}) : _p25;
};
var _chemmi$elm_rocket$Rocket_Updates$updateLanding = function (_p26) {
	var _p27 = _p26;
	var _p32 = _p27.world;
	var _p31 = _p27.rocket;
	var _p28 = _p31.movement;
	if (_p28.ctor === 'Landing') {
		var _p29 = _p28._0;
		return _elm_lang$core$Native_Utils.update(
			_p27,
			{
				rocket: A2(_chemmi$elm_rocket$Rocket_Movement$landOn, _p29, _p31),
				world: _elm_lang$core$Native_Utils.update(
					_p32,
					{
						platforms: A2(_chemmi$elm_rocket$Rocket_Updates$markPlatform, _p29, _p32.platforms)
					})
			});
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
...
var _chemmi$elm_rocket$Rocket_Updates$updateColliding = function (data) {
	return _elm_lang$core$Native_Utils.update(
		data,
		{
			playEvent: _elm_lang$core$Maybe$Just(
				_chemmi$elm_rocket$Rocket_Types$Gameover(data))
		});
};
var _chemmi$elm_rocket$Rocket_Updates$updateFlying = F2(
	function (_p33, diffTime) {
		var _p34 = _p33;
		var _p37 = _p34.world;
		var _p36 = _p34;
		var movedRocket = A4(_chemmi$elm_rocket$Rocket_Movement$moveRocket, _p34.keyDown, _p37.gravity, diffTime, _p34.rocket);
		var _p35 = A2(_chemmi$elm_rocket$Rocket_Movement$tryLanding, movedRocket, _p37);
		if (_p35.ctor === 'Just') {
			return _elm_lang$core$Native_Utils.update(
				_p36,
				{
					rocket: _elm_lang$core$Native_Utils.update(
						movedRocket,
						{
							movement: _chemmi$elm_rocket$Rocket_Types$Landing(_p35._0)
						})
				});
		} else {
			return A2(_chemmi$elm_rocket$Rocket_Collision$collision, movedRocket, _p37) ? _elm_lang$core$Native_Utils.update(
				_p36,
				{
					rocket: _elm_lang$core$Native_Utils.update(
						movedRocket,
						{movement: _chemmi$elm_rocket$Rocket_Types$Colliding})
				}) : _chemmi$elm_rocket$Rocket_Updates$updateDisplayPosition(
				_elm_lang$core$Native_Utils.update(
					_p36,
					{rocket: movedRocket}));
		}
	});
var _chemmi$elm_rocket$Rocket_Updates$isWin = function (_p38) {
	var _p39 = _p38;
	var _p40 = _p39.world;
		...
		switch (_p43.ctor) {
			case 'KeyDownMsg':
				return _elm_lang$core$Native_Utils.update(
					...
					{
						keyDown: A2(
							_chemmi$elm_rocket$Rocket_Updates$updateKeyDown,
							_p46,
							_chemmi$elm_rocket$Rocket_Types$KeyDownMsg(_p43._0))
					});
			case 'KeyUpMsg':
				return _elm_lang$core$Native_Utils.update(
					_p45,
					{
						keyDown: A2(
							_chemmi$elm_rocket$Rocket_Updates$updateKeyDown,
							_p46,
							_chemmi$elm_rocket$Rocket_Types$KeyUpMsg(_p43._0))
					});
			case 'Step':
				if (_elm_lang$core$Basics$not(
					_chemmi$elm_rocket$Rocket_Updates$isWin(_p45))) {
					var _p44 = _p42.rocket.movement;
					switch (_p44.ctor) {
						case 'Landed':
							return _chemmi$elm_rocket$Rocket_Updates$updateLanded(_p45);
						case 'Landing':
							return _chemmi$elm_rocket$Rocket_Updates$updateLanding(_p45);
						case 'Colliding':
							return _chemmi$elm_rocket$Rocket_Updates$updateColliding(_p45);
						default:
							return A2(_chemmi$elm_rocket$Rocket_Updates$updateFlying, _p45, _p43._0);
					}
				} else {
					return _elm_lang$core$Native_Utils.update(
						_p45,
						{
							playEvent: _elm_lang$core$Maybe$Just(
								_chemmi$elm_rocket$Rocket_Types$Win(_p45))
						});
				}
			default:
				return (_elm_lang$core$Native_Utils.cmp(_p45.timeRemaining, 0 * _elm_lang$core$Time$second) < 1) ? _elm_lang$core$Native_Utils.update(
					_p45,
					{
						playEvent: _elm_lang$core$Maybe$Just(
							_chemmi$elm_rocket$Rocket_Types$Gameover(_p45))
					}) : _elm_lang$core$Native_Utils.update(
					_p45,
...
var _chemmi$elm_rocket$Rocket_Updates$updateWorldChoice = F2(
	function (msg, _p47) {
		...
		_v20_2:
		do {
			if (_p49.ctor === 'KeyUpMsg') {
				switch (_p49._0.ctor) {
					case 'Right':
						return _elm_lang$core$Native_Utils.update(
							_p50,
							{
								worldChoice: _chemmi$elm_rocket$Rocket_Updates$rotateRight(_p51)
							});
					case 'Left':
						return _elm_lang$core$Native_Utils.update(
							_p50,
							{
								worldChoice: _chemmi$elm_rocket$Rocket_Updates$rotateLeft(_p51)
							});
					default:
						break _v20_2;
				}
...
var _chemmi$elm_rocket$Rocket_Views$showSmallMessageBox = function (_p0) {
	var _p1 = _p0;
	var height = 15;
	var $default = _evancz$elm_graphics$Text$defaultStyle;
	var messageStyle = _elm_lang$core$Native_Utils.update(
		$default,
		{
			height: _elm_lang$core$Maybe$Just(height),
			color: _elm_lang$core$Color$black,
			typeface: _elm_lang$core$Native_List.fromArray(
				['helvetica'])
		});
	var captionStyle = _elm_lang$core$Native_Utils.update(
		messageStyle,
		{bold: true, color: _elm_lang$core$Color$black});
	return A4(
		...
		A3(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					_evancz$elm_graphics$Collage$moveY,
					(0 - _elm_lang$core$Basics$toFloat(height)) * 0.7,
					A2(
						...
						A2(
							...
							A2(_evancz$elm_graphics$Collage$rect, 100, (2 * height) + 30)))),
					A2(
					_evancz$elm_graphics$Collage$alpha,
					0.6,
					A2(
						...
						A2(_evancz$elm_graphics$Collage$rect, 90, height + 10))),
					A2(
					_evancz$elm_graphics$Collage$moveY,
					_elm_lang$core$Basics$toFloat(height) / 8,
					_evancz$elm_graphics$Collage$text(
						A2(
							_evancz$elm_graphics$Text$style,
							captionStyle,
							_evancz$elm_graphics$Text$fromString(_p1._0)))),
					A2(
					_evancz$elm_graphics$Collage$moveY,
					(_elm_lang$core$Basics$toFloat(height) / 8) - (_elm_lang$core$Basics$toFloat(height) * 1.7),
					_evancz$elm_graphics$Collage$text(
						A2(
							_evancz$elm_graphics$Text$style,
							messageStyle,
							_evancz$elm_graphics$Text$fromString(_p1._1))))
				])));
};
var _chemmi$elm_rocket$Rocket_Views$showMessageBox = function (_p2) {
	var _p3 = _p2;
	var height = 20;
	var $default = _evancz$elm_graphics$Text$defaultStyle;
	var messageStyle = _elm_lang$core$Native_Utils.update(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(
						...
						A2(_evancz$elm_graphics$Collage$rect, 650, height + 10))),
					A2(
					_evancz$elm_graphics$Collage$moveY,
					_elm_lang$core$Basics$toFloat(height) / 8,
					_evancz$elm_graphics$Collage$text(
						A2(
							_evancz$elm_graphics$Text$style,
							captionStyle,
							_evancz$elm_graphics$Text$fromString(_p3._0)))),
					A2(
					_evancz$elm_graphics$Collage$moveY,
					(_elm_lang$core$Basics$toFloat(height) / 8) - (_elm_lang$core$Basics$toFloat(height) * 1.5),
					_evancz$elm_graphics$Collage$text(
						A2(
							_evancz$elm_graphics$Text$style,
							messageStyle,
							_evancz$elm_graphics$Text$fromString(_p3._1))))
				])));
};
...
var _chemmi$elm_rocket$Rocket_Views$viewRocketStatus = function (r) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Rocket Status')
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						_chemmi$elm_rocket$Rocket_Views$viewValue,
						'Position',
						function () {
							var _p4 = r.position;
							var x = _p4._0;
						...
						_chemmi$elm_rocket$Rocket_Views$viewValue,
						'Angle',
						_elm_lang$core$Basics$round(r.angle)),
						A2(
						_chemmi$elm_rocket$Rocket_Views$viewValue,
						'Velocity',
						function () {
							...
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Basics$round(vx),
								_1: _elm_lang$core$Basics$round(vy)
							};
						}()),
						A2(_chemmi$elm_rocket$Rocket_Views$viewValue, 'Fire', r.fire),
						A2(_chemmi$elm_rocket$Rocket_Views$viewValue, 'Acceleration', r.acceleration),
						A2(_chemmi$elm_rocket$Rocket_Views$viewValue, 'Twist', r.twist),
						A2(_chemmi$elm_rocket$Rocket_Views$viewValue, 'touches World', r.touchesWorld),
						A2(_chemmi$elm_rocket$Rocket_Views$viewValue, 'Movement', r.movement),
						A2(_chemmi$elm_rocket$Rocket_Views$viewValue, 'on Platform', r.onPlatform)
					]))
			]));
};
var _chemmi$elm_rocket$Rocket_Views$viewPlayScreen = function (data) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_chemmi$elm_rocket$Rocket_Scene$drawScene(data))
			]));
};
var _chemmi$elm_rocket$Rocket_Views$viewWinScreen = function (data) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _chemmi$elm_rocket$Rocket_Views$viewGameoverScreen = function (data) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _chemmi$elm_rocket$Rocket_Views$viewWorldChoiceScreen = function (_p6) {
	var _p7 = _p6;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_evancz$elm_graphics$Element$layers(
					_elm_lang$core$Native_List.fromArray(
						[
							_chemmi$elm_rocket$Rocket_Scene$drawWorldThumbnail(
							function () {
								var _p8 = _elm_lang$core$List$head(_p7.worldChoice);
								if (_p8.ctor === 'Just') {
									return _p8._0;
								} else {
									return _elm_lang$core$Native_Utils.crashCase(
...
var _chemmi$elm_rocket$Rocket_Views$showInstructions = function (_p10) {
	var _p11 = _p10;
	return _evancz$elm_graphics$Element$layers(
		_elm_lang$core$Native_List.fromArray(
			[
				A4(
				_evancz$elm_graphics$Element$container,
				...
				A2(
					...
					_evancz$elm_graphics$Element$absolute(400),
					_evancz$elm_graphics$Element$absolute(200)),
				A2(
					_evancz$elm_graphics$Element$flow,
					_evancz$elm_graphics$Element$right,
					_elm_lang$core$Native_List.fromArray(
						[
							_chemmi$elm_rocket$Rocket_Views$showSmallMessageBox(
							{ctor: '_Tuple2', _0: 'Accelerate', _1: '[W]'}),
							_chemmi$elm_rocket$Rocket_Scene$drawPortrait(_p11.accelerateAnimation),
							A2(_evancz$elm_graphics$Element$spacer, 50, 1),
							_chemmi$elm_rocket$Rocket_Scene$drawPortrait(_p11.rotateAnimation),
							_chemmi$elm_rocket$Rocket_Views$showSmallMessageBox(
							{ctor: '_Tuple2', _0: 'Rotate', _1: '[A] and [D]'})
						]))),
				A4(
				_evancz$elm_graphics$Element$container,
				800,
				...
				A2(
					_evancz$elm_graphics$Element$middleAt,
					_evancz$elm_graphics$Element$absolute(400),
					_evancz$elm_graphics$Element$absolute(430)),
				A2(
					_evancz$elm_graphics$Element$flow,
					_evancz$elm_graphics$Element$right,
					_elm_lang$core$Native_List.fromArray(
						[
							_chemmi$elm_rocket$Rocket_Views$showSmallMessageBox(
							{ctor: '_Tuple2', _0: 'Landing', _1: 'Not too fast !!'}),
							_chemmi$elm_rocket$Rocket_Scene$drawPortrait(_p11.landAnimation),
							_chemmi$elm_rocket$Rocket_Views$showSmallMessageBox(
							{ctor: '_Tuple2', _0: 'Toggle Music', _1: '[M]'})
						])))
			]));
};
var _chemmi$elm_rocket$Rocket_Views$viewInfoScreen = function (data) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_evancz$elm_graphics$Element$layers(
					_elm_lang$core$Native_List.fromArray(
						[
							_chemmi$elm_rocket$Rocket_Views$showInstructions(data),
							_chemmi$elm_rocket$Rocket_Views$showMessageBox(
							{ctor: '_Tuple2', _0: 'Objective', _1: 'Land on all platforms in time !'})
						])))
			]));
};
var _chemmi$elm_rocket$Rocket_Views$viewStartScreen = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[]),
	_elm_lang$core$Native_List.fromArray(
...
var _chemmi$elm_rocket$Rocket_Views$viewScreen = function (screen) {
	...
	switch (_p12.ctor) {
		case 'StartScreen':
			return _chemmi$elm_rocket$Rocket_Views$viewStartScreen;
		case 'InfoScreen':
			return _chemmi$elm_rocket$Rocket_Views$viewInfoScreen(_p12._0);
		case 'WorldChoiceScreen':
			return _chemmi$elm_rocket$Rocket_Views$viewWorldChoiceScreen(_p12._0);
		case 'PlayScreen':
			return _chemmi$elm_rocket$Rocket_Views$viewPlayScreen(_p12._0);
		case 'GameoverScreen':
			return _chemmi$elm_rocket$Rocket_Views$viewGameoverScreen(_p12._0);
		default:
			return _chemmi$elm_rocket$Rocket_Views$viewWinScreen(_p12._0);
	}
};
...
var _chemmi$elm_rocket$Rocket_Audio$audio = _elm_lang$core$Native_Platform.outgoingPort(
	'audio',
	function (v) {
		return [v._0, v._1];
	});
...
var _chemmi$elm_rocket$Rocket$changeToPlay = function (_p3) {
	var _p4 = _p3;
	var world = function () {
		var _p5 = _elm_lang$core$List$head(_p4.worldChoice);
		if (_p5.ctor === 'Just') {
			return _p5._0;
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
				'Rocket',
				{
					...
					end: {line: 188, column: 49}
				},
				_p5)('No world found');
		}
	}();
	var playData = _elm_lang$core$Native_Utils.update(
		_chemmi$elm_rocket$Rocket_Inits$initPlay,
		{
			world: world,
			timeRemaining: world.totalTime,
			rocket: _elm_lang$core$Native_Utils.update(
	...
	return A2(
		...
		_chemmi$elm_rocket$Rocket_Types$PlayScreen(playData),
		_p4);
};
var _chemmi$elm_rocket$Rocket$changeToWorldChoice = function (options) {
	return A2(
		_chemmi$elm_rocket$Rocket_Types$Model,
		_chemmi$elm_rocket$Rocket_Types$WorldChoiceScreen(
			_elm_lang$core$Native_Utils.update(
				_chemmi$elm_rocket$Rocket_Inits$initWorldChoice,
				{worldChoice: options.worldChoice})),
		options);
};
var _chemmi$elm_rocket$Rocket$changeScreen = F2(
	function (msg, _p7) {
		var _p8 = _p7;
		var _p14 = _p8._0;
		var _p13 = _p8._1;
					...
					case 'Start':
						...
						switch (_p10.ctor) {
							case 'StartScreen':
								return A2(
									_chemmi$elm_rocket$Rocket_Types$Model,
									_chemmi$elm_rocket$Rocket_Types$InfoScreen(_chemmi$elm_rocket$Rocket_Inits$initInfo),
									_p13);
							case 'InfoScreen':
								return _chemmi$elm_rocket$Rocket$changeToWorldChoice(_p13);
							case 'WorldChoiceScreen':
								return _chemmi$elm_rocket$Rocket$changeToPlay(
									_elm_lang$core$Native_Utils.update(
										_p13,
										{worldChoice: _p10._0.worldChoice}));
							case 'PlayScreen':
								return _p12;
							case 'GameoverScreen':
								return _chemmi$elm_rocket$Rocket$changeToPlay(_p13);
							default:
								return _chemmi$elm_rocket$Rocket$changeToWorldChoice(_p13);
						}
					case 'Back':
						...
						switch (_p11.ctor) {
							case 'StartScreen':
								return _p12;
							case 'InfoScreen':
								return A2(_chemmi$elm_rocket$Rocket_Types$Model, _chemmi$elm_rocket$Rocket_Types$StartScreen, _p13);
							case 'WorldChoiceScreen':
								return A2(
									_chemmi$elm_rocket$Rocket_Types$Model,
									_chemmi$elm_rocket$Rocket_Types$InfoScreen(_chemmi$elm_rocket$Rocket_Inits$initInfo),
...
var _chemmi$elm_rocket$Rocket$view = function (_p15) {
	var _p16 = _p15;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$id('gameScreen')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_chemmi$elm_rocket$Rocket_Views$viewScreen(_p16._0)
			]));
};
var _chemmi$elm_rocket$Rocket$isScreenControlKey = function (key) {
	var _p17 = key;
	switch (_p17.ctor) {
		case 'Start':
			return true;
...
var _chemmi$elm_rocket$Rocket$isScreenControlMsg = function (msg) {
	var _p18 = msg;
	if (_p18.ctor === 'KeyUpMsg') {
		return _chemmi$elm_rocket$Rocket$isScreenControlKey(_p18._0);
	} else {
		return false;
	}
};
var _chemmi$elm_rocket$Rocket$updateModel = F2(
	function (msg, _p19) {
		var _p20 = _p19;
		var _p25 = _p20._1;
		var _p24 = _p20;
		if (_chemmi$elm_rocket$Rocket$isScreenControlMsg(msg)) {
			return A2(_chemmi$elm_rocket$Rocket$changeScreen, msg, _p24);
		} else {
			var _p21 = _p20._0;
			switch (_p21.ctor) {
				case 'PlayScreen':
					var _p23 = _p21._0;
					var _p22 = _p23.playEvent;
					if (_p22.ctor === 'Nothing') {
						...
						if (_p22._0.ctor === 'Gameover') {
							var background = _chemmi$elm_rocket$Rocket_Scene$drawScene(_p22._0._0);
							return A2(
								_chemmi$elm_rocket$Rocket_Types$Model,
								_chemmi$elm_rocket$Rocket_Types$GameoverScreen(
									_elm_lang$core$Native_Utils.update(
							...
							return A2(
								_chemmi$elm_rocket$Rocket_Types$Model,
								_chemmi$elm_rocket$Rocket_Types$WinScreen(
									_elm_lang$core$Native_Utils.update(
...
var _chemmi$elm_rocket$Rocket$keyBinding = function (code) {
	var _p26 = _elm_lang$core$Char$fromCode(code);
	switch (_p26.valueOf()) {
		case 'A':
			return _chemmi$elm_rocket$Rocket_Types$Left;
		case 'D':
			return _chemmi$elm_rocket$Rocket_Types$Right;
		case 'W':
			return _chemmi$elm_rocket$Rocket_Types$Up;
		case 'S':
			return _chemmi$elm_rocket$Rocket_Types$Down;
		case ' ':
...
var _chemmi$elm_rocket$Rocket$subscriptions = function (_p27) {
	var _p28 = _p27;
				...
				[
					...
					function (_p29) {
						return _chemmi$elm_rocket$Rocket_Types$KeyDownMsg(
							_chemmi$elm_rocket$Rocket$keyBinding(_p29));
					}),
					_elm_lang$keyboard$Keyboard$ups(
					function (_p30) {
						return _chemmi$elm_rocket$Rocket_Types$KeyUpMsg(
							_chemmi$elm_rocket$Rocket$keyBinding(_p30));
					})
				]),
			function () {
				var _p31 = _p28._0;
...
var _chemmi$elm_rocket$Rocket$main = {
	main: _elm_lang$html$Html_App$program(
		{
			...
			subscriptions: _chemmi$elm_rocket$Rocket$subscriptions
		})
};

var Elm = {};
Elm['Rocket'] = Elm['Rocket'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Rocket'], 'Rocket', typeof _chemmi$elm_rocket$Rocket$main === 'undefined' ? null : _chemmi$elm_rocket$Rocket$main);
